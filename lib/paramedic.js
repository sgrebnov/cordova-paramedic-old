...
function ParamedicRunner(targets,_plugins,_callback,nPort,msTimeout,bSilent,bVerbose,platformPath,externalServerUrl) {
    this.tunneledUrl = "";
    this.port = nPort;
...
ParamedicRunner.prototype = {
    run: function() {
        ...
        return Server.startServer(this.port, this.externalServerUrl).then(function (server) {
...
exports.run = function(paramedicConfig,_platformId,_plugins,_callback,bJustBuild,nPort,msTimeout,bBrowserify,bSilent,bVerbose,platformPath) {
    ...
    var runner = new ParamedicRunner(targets, plugins, _callback,
        nPort || PORT, msTimeout || TIMEOUT, !!bVerbose, bVerbose, null, paramedicConfig ? parseExternalServerUrlFromConfig(paramedicConfig) : null);
