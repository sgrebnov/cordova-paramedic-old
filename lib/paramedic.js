...
function ParamedicRunner(targets,_plugins,_callback,nStartPort,nEndPort,msTimeout,bSilent,bVerbose,platformPath,externalServerUrl,useTunnel) {
    this.tunneledUrl = "";
...
exports.run = function(paramedicConfig,_platformId,_plugins,_callback,bJustBuild,nStartPort,nEndPort,msTimeout,bBrowserify,bSilent,bVerbose,platformPath) {
    ...
    var runner = new ParamedicRunner(targets, plugins, _callback,
        nStartPort || START_PORT, nEndPort || END_PORT, msTimeout || TIMEOUT, !!bVerbose, bVerbose, null,
        paramedicConfig ? paramedicConfig.getExternalServerUrl() : null, paramedicConfig ? paramedicConfig.useTunnel() : false);
